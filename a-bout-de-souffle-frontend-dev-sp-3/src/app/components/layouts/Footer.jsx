  ...
  return (
    <footer className="p-4 sm:p-6 bg-black">
      <div className="md:flex md:justify-between">
        ...
        <div>
          <Link
            className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-red-800/80 mr-4"
            to="/cgv"
          >
          ...
          <Link
            ...
            to="/cgv2"
          >
            Conditions générales de ventes 2
          </Link>
          <li className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-red-800/80 mr-4">
            <PopUp />
          </li>
          <li className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-red-800/80 mr-4">
            <Modal/>
